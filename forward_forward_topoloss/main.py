...
from utils import visualize_sample, plot_loss, plot_accuracy
...
# Plot results
plot_loss([layer.loss_history for layer in net.layers], name="topological_loss.png")
plot_accuracy(accuracy_histories, name="accuracy.png")
